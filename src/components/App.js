        ...
        <div className="App">
            <div className="page__container">
                ...
                <Main 
                    ...
                    />
                <Footer />
                <PopupWithForm onClose={closeAllPopups} isOpened={isEditProfilePopupOpen} styleClass="profile" title="Редактировать профиль" name="edit_profile" buttonText="Сохранить"
                ...
                />
                <PopupWithForm onClose={closeAllPopups} isOpened={isAddPlacePopupOpen} styleClass="content" title="Новое место" name="new_content" buttonText="Создать"
                ...
                />
                <PopupWithForm onClose={closeAllPopups} isOpened={isEditAvatarPopupOpen} styleClass="avatar" title="Обновить аватар" name="edit_avatar" buttonText="Сохранить"
